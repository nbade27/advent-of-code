...
public class DayTwoPuzzleTwo {
    ...
    public static Integer maxRedCubes = 0;
    public static Integer maxGreenCubes = 0;
    public static Integer maxBlueCubes = 0;
...
//                    System.out.println("colours :" + colours[k].trim());
            ...
            if(maxRedCubes != 0)
                gamePower *= maxRedCubes;
            if (maxBlueCubes != 0)
                gamePower *= maxBlueCubes;
            if (maxGreenCubes != 0)
                gamePower *= maxGreenCubes;
            totalSumOfPowers += gamePower;

        }// game
        System.out.println("totalCount: " + totalSumOfPowers);
    }
}
