...
//            System.out.println(eachWord);
            ...
            for (int j = 0; j < eachWord.length(); j++) {
                ...
                int ascii = eachWord.charAt(j);

                if (ascii >= 48 && ascii <= 57){
                    numberString = numberString + String.valueOf(eachWord.charAt(j));
                }
            }
//            System.out.println("numberString" + numberString);


            // extracting required integers
            if(!"".equals(numberString)){
                String requiredString = String.valueOf(numberString.charAt(0)) + String.valueOf(numberString.charAt(numberString.length() -1));
                int requiredNumber = Integer.parseInt(requiredString);
